...
const getUsersChannleProfile = asyncHandler(async (req, res) => {
  ...
  console.log("channel data", channle);

  return res
    .status(200)
    .json(
      new ApiResponse(200, channle[0], "User channel fethced successfully")
    );
});
